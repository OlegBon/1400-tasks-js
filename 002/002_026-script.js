...
input.placeholder = "Введіть координати двох точок"; // Плейсхолдер для поля ввода
...
let arrIn = ["x1", "y1", "x2", "y2"]; // Масив назв змінних для виводу
...
button.addEventListener("click", function () {
  ...
  if (nmbr.length === 4) {
    try {
      let distance = calculateDistance(nmbr[0], nmbr[1], nmbr[2], nmbr[3]);
      outputParagraph.textContent = `Точки: x1 = ${nmbr[0]}, y1 = ${nmbr[1]}, x2 = ${nmbr[2]}, y2 = ${nmbr[3]}. Відстань між точками: ${distance}.`;
    } catch (error) {
